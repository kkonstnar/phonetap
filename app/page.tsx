    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-start md:items-center">
            <div className="space-y-6 order-1 md:order-1">
              <div className="space-y-6">
                <h1 className="tracking-tight font-normal text-6xl animate-fade-up animation-delay-100">Turn your phone into a <span className="text-[#3AB75C]">payment</span> terminal</h1>
                <p className="text-gray-600 font-normal text-md animate-fade-up animation-delay-200">
              ...
              <div className="space-y-4">
                ...
                {/* <div className="flex items-center space-x-2 animate-fade-up animation-delay-300">
            ...
            <div className="flex justify-center items-center animate-fade-up animation-delay-500 order-2 md:order-2 overflow-hidden">
              <div className="w-[400px] min-h-[400px] md:w-[400px] md:h-[500px] flex items-center justify-center">
                <Image
      ...
      <section className="px-6 py-20">
        <div className="max-w-2xl mx-auto text-center space-y-6">
          ...
          <p className="text-sm text-gray-500 animate-fade-up animation-delay-300">Free • No monthly fees • 3.9% + JMD $70.00 per transaction</p>
        </div>
      </section>
